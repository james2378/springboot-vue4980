<template>
<div class="content box5" :style='{"alignContent":"flex-start","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230313/0b043a1da9554748b9083dd40edbb09a.jpg) no-repeat center top / 100% 100%,#040e29","display":"flex","width":"100%","position":"relative","height":"auto"}'>
	<!-- 标题 -->
...
<!-- 1 -->
		...
		<div :style='{"margin":"0 0 20px","alignItems":"center","borderRadius":"20px","background":"rgba(255,255,255,.1)","display":"flex","width":"100%","justifyContent":"center"}'>
			...
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"14px","color":"#fff","height":"32px"}'>用户总数</div>
				<div :style='{"lineHeight":"32px","fontSize":"18px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{yonghuCount}}</div>
			</div>
		</div>
...
<!-- 2 -->
		...
		<div :style='{"margin":"0 0 20px","alignItems":"center","borderRadius":"20px","background":"rgba(255,255,255,.2)","display":"flex","width":"100%","justifyContent":"center"}'>
			...
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"14px","color":"#fff","height":"32px"}'>旅游数据总数</div>
				<div :style='{"lineHeight":"32px","fontSize":"18px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{lvyoushujuCount}}</div>
			</div>
		</div>
	...
	<div class="tables">
		<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,.1)","width":"100%","lineHeight":"64px","fontSize":"28px","height":"64px"}'>旅游数据(评论人数TOP10)</div>
        <el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#333","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
          <el-table-column :resizable="true" :sortable="true" prop="diming" label="地名"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="jingdianming" label="景点名"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="pinglunrenshu" label="评论人数"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="gonglveshuliang" label="攻略数量"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="paiming" label="排名"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="xingji" label="星级"/>
          </el-table-column>
        </el-table>
	</div>
	
	<div class="echarts1">
		<div id="lvyoushujuChart1" style="width:100%;height:100%;"></div>
	</div>
	<div class="echarts2">
		<div id="lvyoushujuChart2" style="width:100%;height:100%;"></div>
	</div>
	<div class="echarts3">
		<div id="lvyoushujuChart3" style="width:100%;height:100%;"></div>
	</div>
	<div class="echarts4">
		<div id="lvyoushujuChart4" style="width:100%;height:100%;"></div>
	</div>
	<div class="echarts5">
		<div id="lvyoushujuChart5" style="width:100%;height:100%;"></div>
	</div>
...
export default {
  ...
  mounted(){
    ...
    this.getDataList();
    this.getyonghuCount();
    this.getlvyoushujuCount();
    this.lvyoushujuChat1();
    this.lvyoushujuChat2();
    this.lvyoushujuChat3();
    this.lvyoushujuChat4();
    this.lvyoushujuChat5();
  },
  created() {
    this.$nextTick(()=>{
		this.times()
  ...
  methods:{
    ...
    getlvyoushujuCount() {
        this.$http({
            url: `lvyoushuju/count`,
            method: "get"
        }).then(({
            data
        }) => {
            if (data && data.code == 0) {
                this.lvyoushujuCount = data.data
            }
        })
    },
...
//统计接口1
    lvyoushujuChat1() {
      this.$nextTick(()=>{
        ...
        var lvyoushujuChart1 = echarts.init(document.getElementById("lvyoushujuChart1"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                lvyoushujuChart1.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, lvyoushujuChart1)

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    lvyoushujuChart1.resize();
                };
            }
        });
      })
...
//统计接口2
    lvyoushujuChat2() {
      this.$nextTick(()=>{
        ...
        var lvyoushujuChart2 = echarts.init(document.getElementById("lvyoushujuChart2"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                lvyoushujuChart2.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, lvyoushujuChart2)

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    lvyoushujuChart2.resize();
                };
            }
        });
      })
...
//统计接口3
    lvyoushujuChat3() {
      this.$nextTick(()=>{
        ...
        var lvyoushujuChart3 = echarts.init(document.getElementById("lvyoushujuChart3"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                lvyoushujuChart3.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    lvyoushujuChart3.resize();
                };
            }
        });
      })
...
//统计接口4
    lvyoushujuChat4() {
      this.$nextTick(()=>{
        ...
        var lvyoushujuChart4 = echarts.init(document.getElementById("lvyoushujuChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                lvyoushujuChart4.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    lvyoushujuChart4.resize();
                };
            }
        });
      })
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                var option = {};
                this.wordclouds(pArray,'lvyoushujuChart5');

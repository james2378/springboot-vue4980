...
<div class="content" :style='{"minHeight":"100vh","padding":"0 30px"}'>
    ...
    <div class="cardView">
        <div class="cards" :style='{"margin":"0 0 20px 0","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
			<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"3px 10px","borderRadius":"40px","display":"flex"}' v-if="isAuth('yonghu','首页总数')">
			...
			<div :style='{"boxShadow":"0 1px 6px rgba(0,0,0,.3)","margin":"3px 10px","borderRadius":"40px","display":"flex"}' v-if="isAuth('lvyoushuju','首页总数')">
				<div :style='{"width":"80px","background":"#ffc523","height":"80px"}'></div>
				<div :style='{"width":"160px","alignItems":"center","flexDirection":"column","justifyContent":"center","display":"flex"}'>
					<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"20px","color":"#333","fontWeight":"bold","height":"24px"}'>{{lvyoushujuCount}}</div>
					<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"16px","color":"#666","height":"24px"}'>旅游数据总数</div>
				</div>
			</div>
        </div>
    </div>
